...
author: "Sebastian DiLorenzo, Marcin Kierczak"
output:
...
<p class="abstract">
The main goal of the group project is to work together efficiently and to use several tools that you have aquired during RaukR.
</p>
...
Each group will have 10-15 minutes to present starting **Thursday the 24th of July** followed by 5 minutes for questions. Generate the presentation using **Rmarkdown** and any other presentation specific R packages that you wish (for example `xaringan`).
