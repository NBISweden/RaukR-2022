...
knitr::opts_chunk$set(dev="png",results="hold",fig.show="hold",fig.align="left",echo=TRUE,warning=FALSE,message=FALSE,accordion=NULL,block.title=NULL,eval=TRUE)
```
