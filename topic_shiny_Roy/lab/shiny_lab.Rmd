...
![](shiny_lab_assets/data-explorer.png)
...
```{r,fig.height=4.5,fig.width=7}
dfr$track[dfr$date>=as.Date("2022-06-13") & dfr$date<=as.Date("2022-06-17")] <- "RaukR"
dfr$track[dfr$date==as.Date("2022-06-24")] <- "Midsummer"
